...
const SignUp = () => {
  ...
  const [showPassword,setShowPassword,name] = useState(false);
  ...
  return (
    ...
    <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
      ...
      <p className='mb-6'>
       Have a account? 
      <Link to='/sign-in' className='text-red-500 hover:text-red-700 cursor-pointer transition duration-200 ease-in-out ml-1'>Sign IN</Link>
      </p>
      <p className=''>
