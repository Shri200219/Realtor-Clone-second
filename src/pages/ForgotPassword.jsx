...
const ForgotPassword = () => {
  ...
  return (
    <section>
      <h1 className='text-3xl text-center mt-7 font-bold'>Forgot Password</h1>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20 '>
          <form>
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              ...
              <p className=''>
                <Link to='/sign-in ' className='text-blue-500 hover:text-blue-700 cursor-pointer transition duration-200 ease-in-out ml-1' >Sign in instead</Link>
              </p>
            </div>
            <button
              type='submit'
